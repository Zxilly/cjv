...
// Tests for Do -- the shared retry engine used by
...
func TestDo_SucceedsImmediately(t *testing.T) {
	...
	attempts := 0
	err := Do(3, func(error) bool { return true }, func() error {
		attempts++
		return nil
	})
...
func TestDo_RecoversFromTransientFailure(t *testing.T) {
	...
	attempts := 0
	err := Do(5, func(error) bool { return true }, func() error {
		attempts++
		if attempts < 3 {
...
func TestDo_StopsOnPermanentError(t *testing.T) {
	...
	err := Do(10, func(error) bool { return false }, func() error {
		attempts++
		return permanentErr
	})
...
func TestDo_SingleAttempt(t *testing.T) {
	...
	attempts := 0
	err := Do(1, func(error) bool { return true }, func() error {
		attempts++
