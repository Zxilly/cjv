...
func (app *application) linkURL(t *testing.T, name, url string) error {
	t.Helper()
	return app.toolchainLinkCmd.RunE(app.toolchainLinkCmd, []string{name, url})
}
...
func TestToolchainLinkURL_SDKAndStdx(t *testing.T) {
	...
	require.NoError(t, app.linkURL(t, "my-sdk", url))
...
func TestToolchainLinkURL_ForceReinstall(t *testing.T) {
	...
	require.NoError(t, app.linkURL(t, "my-sdk", url))
	require.Error(t, app.linkURL(t, "my-sdk", url), "second install without --force must fail")

	app.linkForce = true
	require.NoError(t, app.linkURL(t, "my-sdk", url), "second install with --force must succeed")
}
...
func TestToolchainLinkURL_ReservedName(t *testing.T) {
	...
	require.Error(t, app.linkURL(t, "lts", "https://example.invalid/sdk.zip"))
...
func TestToolchainLinkURL_CrossOSRejected(t *testing.T) {
	...
	require.Error(t, app.linkURL(t, "cross", serveBytes(t, outer)))
...
func TestToolchainLinkURL_BareArchiveCrossOSRejected(t *testing.T) {
	...
	require.Error(t, app.linkURL(t, "barecross", serveBytes(t, bare)))
...
func TestToolchainLinkURL_CrossOSRejectedMacBinary(t *testing.T) {
	...
	require.Error(t, app.linkURL(t, "mac", serveBytes(t, outer)))
...
func TestToolchainLinkURL_ForceReinstallWithStdx(t *testing.T) {
	...
	require.NoError(t, app.linkURL(t, "my-sdk", serveBytes(t, first)))
...
func TestToolchainLinkURL_FlagOnLocalPathRejected(t *testing.T) {
	...
	require.Error(t, app.linkURL(t, "local-sdk", target))
